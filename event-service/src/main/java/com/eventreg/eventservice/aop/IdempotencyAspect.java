package com.eventreg.eventservice.aop;

import com.eventreg.eventservice.model.IdempotencyRecord;
...
public class IdempotencyAspect {
  ...
  @Around("@annotation(com.eventreg.eventservice.annotation.Idempotent)")
