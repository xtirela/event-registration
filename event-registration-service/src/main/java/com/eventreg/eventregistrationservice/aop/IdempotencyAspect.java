package com.eventreg.eventregistrationservice.aop;
...
/** Coordinates idempotent request handling via claims in the idempotency table. */
@Slf4j
@Aspect
@Component
...
public class IdempotencyAspect {
  ...
  /** Checks the Idempotency-Key header and either runs or waits for the claimed operation. */
  @Around("@annotation(com.eventreg.eventregistrationservice.annotation.Idempotent)")
