...
public class ConsoleView
{
    ...
    public void performAction(int action, Scanner scanner)
    {
        ...
        {
                case 1:
                    System.out.println("Введите данные участника через запятую без пробелов \nимя,фамилия,email,возраст,пол(MALE/FEMALE/NOT_SPECIFIED): ");
                ...
                case 3:
                    ...
                    EventRegRequest eventRegRequest = EventRegRequest.builder()
                ...
                case 4:
                    ...
                    scanner.nextLine();
                    CancelRegRequest cancelRegRequest = CancelRegRequest.builder()
