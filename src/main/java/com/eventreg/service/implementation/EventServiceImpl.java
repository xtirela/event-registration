...
import com.eventreg.collection.SimpleLinkedList;
...
public class EventServiceImpl implements EventService {
  ...
  public EventServiceImpl(
      ...
      ParticipantRepository userRepository,
  ...
  public ParticipantResponse createParticipant(ParticipantCreateRequest participantCreateRequest) {
    ...
    if (userRepository.existsByEmail(participantCreateRequest.getEmail())) {
      throw new DuplicateException(
  ...
  private void deleteParticipant(Integer participantId) {
    ...
    userRepository.delete(participantId);
  }

  @Override
  public EventRegResponse registerParticipant(EventRegRequest eventRegRequest) {

    Participant participant = userRepository.findById(eventRegRequest.getUserId());
    if (participant == null) {
      throw new ParticipantNotFoundException(
          eventRegRequest.getUserId(), "registerParticipant");
    }
    ...
    EventRegistration eventRegistration =
        EventRegistration.builder()
            .participantId(eventRegRequest.getUserId())
  ...
  public ParticipantResponse getParticipantById(int participantId) {
    Participant participant = userRepository.findById(participantId);
    if (participant != null) {
      return ParticipantResponse.builder()
          .participantId(participant.getId())
          .firstName(participant.getFirstName())
  ...
  @Override
  public EventSummaryResponse getEventSummary(int eventId) {
    EventSummaryResponse eventSummaryResponse = eventRepository.getEventSummary(eventId);
    if (eventSummaryResponse != null) {
  ...
  public List<Participant> searchByFragment(String fragment) {
    return userRepository.searchByFragment(fragment);
  }
  ...
  private EventRegResponse eventRegistrationToEventRegResponse(
    ...
    Participant participant = userRepository.findById(eventRegistration.getParticipantId());
    if (participant == null) {
      throw new ParticipantNotFoundException(
