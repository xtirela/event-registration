...
import dto.ParticipantEventPair;
...
public class ConsoleViewTest
{
    ...
    public void givenValidData_WhenCreateParticipant_ThenReturnParticipantResponse(String input, String output)
    {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/view/csv/participant_create_request_edge_cases.csv", numLinesToSkip = 1)
    public void givenEdgeCasesData_WhenCreateParticipant_ThenReturnParticipantResponse(String input, String output)
    {
        performConsoleAction(1, input);
    ...
    public void givenInvalidData_WhenCreateParticipant_ThenReturnParticipantResponse(String input, String output)
    {
        performConsoleAction(1, input);
    ...
    public void givenEdgeCaseData_WhenCreateEvent_ThenReturnEventResponse(String input, String output)
    {
        performConsoleAction(2, input);
    ...
    public void givenInvalidData_WhenCreateEvent_ThenReturnEventResponseWithError(String input, String output)
    {
        performConsoleAction(2, input);
    ...
    public void givenValidData_WhenRegisterParticipant_ThenReturnEventRegResponse(String participantCreateInput,
    ...
    public void givenEdgeCaseData_WhenRegisterParticipant_ThenReturnEventRegResponse(String participantCreateInput,
                                                                                  String eventCreateInput,
                                                                                  String eventRegInput,
                                                                                  String eventRegOutput)
    {
    ...
    public void givenInvalidData_WhenRegisterParticipant_ThenReturnEventRegResponseError(String participantCreateInput,
                                                                                     String eventCreateInput,
                                                                                     String eventRegInput)
    {
        performConsoleAction(1, participantCreateInput);
    ...
    public void givenValidData_WhenCancelRegistration_ThenRegistrationCancelled(String participantCreateInput,
                                                                                String eventCreateInput,
                                                                                String eventRegInput,
                                                                                String cancelRegInput,
                                                                                String eventRegOutput) throws InterruptedException {
        performConsoleAction(1, participantCreateInput);
    ...
    public void givenEdgeCaseData_WhenCancelRegistration_ThenRegistrationCancelled(String participantCreateInput,
                                                                                   String eventCreateInput,
                                                                                   String eventRegInput,
                                                                                   String cancelRegInput,
                                                                                   String eventRegOutput) throws InterruptedException {
    ...
    public void givenInvalidData_WhenCancelRegistration_ThenRegistrationNotCancelled(String participantCreateInput,
                                                                                     String eventCreateInput,
                                                                                     String eventRegInput,
                                                                                     String cancelRegInput,
                                                                                     String eventRegOutput) throws InterruptedException {
    ...
    public void givenValidData_WhenGetEventById_ThenReturnEvent(String eventCreateInput, String eventIdInput) {
        performConsoleAction(2, eventCreateInput);
    ...
    public void givenInvalidData_WhenGetEventById_ThenReturnError(String eventCreateInput, String eventIdInput) {
        performConsoleAction(2, eventCreateInput);
    ...
    public void givenValidData_WhenGetAllEvents_ThenReturnEventList(String eventCreateInput1, String eventCreateInput2, String expectedOutput) {
    ...
    public void givenValidData_WhenGetParticipantById_ThenReturnParticipant(String participantCreateInput, String participantIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
    ...
    public void givenInvalidData_WhenGetParticipantById_ThenReturnError(String participantCreateInput, String participantIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
    ...
    public void givenValidData_WhenGetAllParticipants_ThenReturnParticipantList(String participantCreateInput1, String participantCreateInput2, String expectedOutput) {
    ...
    public void givenValidData_WhenGetRegistrationById_ThenReturnRegistration(String participantCreateInput, String eventCreateInput, String eventRegInput, String requestIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
        performConsoleAction(2, eventCreateInput);
        performConsoleAction(3, eventRegInput);
    ...
    public void givenInvalidData_WhenGetRegistrationById_ThenReturnError(String participantCreateInput, String eventCreateInput, String eventRegInput, String requestIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
        performConsoleAction(2, eventCreateInput);
        performConsoleAction(3, eventRegInput);
    ...
    public void givenValidData_WhenGetAllRegistrations_ThenReturnRegistrationList(String participantCreateInput1, String eventCreateInput1, String eventRegInput1, String participantCreateInput2, String eventCreateInput2, String eventRegInput2, String expectedOutput) {
        performConsoleAction(1, participantCreateInput1);
        performConsoleAction(2, eventCreateInput1);
    ...
    public void givenValidData_WhenGetParticipantEvents_ThenReturnEventList(String participantCreateInput, String eventCreateInput1, String eventRegInput1, String eventCreateInput2, String eventRegInput2, String participantIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
        performConsoleAction(2, eventCreateInput1);
        performConsoleAction(3, eventRegInput1);
        performConsoleAction(2, eventCreateInput2);
    ...
    public void givenInvalidData_WhenGetParticipantEvents_ThenReturnEmptyList(String participantCreateInput, String eventCreateInput, String eventRegInput, String participantIdInput, String expectedOutput) {
        performConsoleAction(1, participantCreateInput);
        performConsoleAction(2, eventCreateInput);
        performConsoleAction(3, eventRegInput);
        assertDoesNotThrow(()->performConsoleAction(11, participantIdInput));
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/view/csv/get_all_registered_participants_valid.csv", numLinesToSkip = 1)
    public void givenValidData_WhenGetAllRegisteredParticipants_ThenReturnAllPairs(String participantCreateInput1, String eventCreateInput1, String eventRegInput1, String participantCreateInput2, String eventCreateInput2, String eventRegInput2, String expectedOutput) {
        performConsoleAction(1, participantCreateInput1);
        performConsoleAction(2, eventCreateInput1);
        performConsoleAction(3, eventRegInput1);
        performConsoleAction(1, participantCreateInput2);
