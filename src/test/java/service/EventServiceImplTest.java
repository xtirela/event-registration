...
public class EventServiceImplTest {
    ...
    public void setUp() {
        ...
        String[] eventInput2 = {"Test event two","2040-01-01T12:00:00+00:00","100","10","10","NONE"};

        EventCreateRequest eventCreateRequest2 = EventCreateRequest.builder()
        ...
        ParticipantCreateRequest participantCreateRequest = ParticipantCreateRequest.builder()
                .firstName(input[0])
                .lastName(input[1])
                .email(input[2])
        ...
        ParticipantCreateRequest participantCreateRequest2 = ParticipantCreateRequest.builder()
                .firstName(input2[0])
                .lastName(input2[1])
                .email(input2[2])
        ...
        EventRegRequest eventRegRequest = EventRegRequest.builder().participantId(regInput[0]).eventId(regInput[1]).build();

        eventService.registerParticipant(eventRegRequest);

        int[] regInput2 = {2,1};

        EventRegRequest eventRegRequest2 = EventRegRequest.builder().participantId(regInput2[0]).eventId(regInput2[1]).build();

        eventService.registerParticipant(eventRegRequest2);

        int[] regInput3 = {2,2};

        EventRegRequest eventRegRequest3 = EventRegRequest.builder().participantId(regInput3[0]).eventId(regInput3[1]).build();
