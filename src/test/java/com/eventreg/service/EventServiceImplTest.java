...
//import com.eventreg.dto.response.EventRegResponse;
...
//import com.eventreg.exception.EventCapacityExceededException;
//import com.eventreg.exception.EventNotFoundException;
//import com.eventreg.exception.EventRegException;
//import com.eventreg.exception.IllegalArgumentEventRegException;
//import com.eventreg.exception.ParticipantNotFoundException;
//import com.eventreg.exception.RegistrationNotFoundException;
...
//import com.eventreg.repository.implementation.Jdbc.EventRegistrationRepositoryJdbc;
//import com.eventreg.repository.implementation.Jdbc.EventRepositoryJdbc;
//import com.eventreg.repository.implementation.Jdbc.ParticipantRepositoryJdbc;
...
//        .eventName(name)
//        .location("com.eventreg.PartyApplication Hall")
//        .eventDate(date)
...
//    EventResponse response = eventService.createEvent(event("Tech Conference", 18, 100));
//
//    assertEquals("com.eventreg.PartyApplication Hall", response.getLocation());
//  }
//
//  @Test
...
//    Map<String, List<EventResponse>> grouped = eventService.getEventsGrouped(Event::getLocation);
//
//    assertEquals(1, grouped.get("com.eventreg.PartyApplication Hall").size());
//  }
//
